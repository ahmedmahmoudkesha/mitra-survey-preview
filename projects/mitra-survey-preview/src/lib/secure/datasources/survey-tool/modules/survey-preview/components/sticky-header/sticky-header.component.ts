...
export class StickyHeaderComponent {
  /*
	@ViewChild("bottomMarkerRef", { static: false })
	bottomMarkerRef: ElementRef;

	@ViewChild("topMarkerRef", { static: false })
	topMarkerRef: ElementRef;
